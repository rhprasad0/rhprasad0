...
- [`aws-ai-evals`](https://github.com/rhprasad0/aws-ai-evals) — an AWS-native AI evaluation harness (Bedrock model-evals, deterministic gates, judge calibration) around a recruiter-facing evidence chatbot
...
- **I make AI systems measurable.** This is the work I lead with now: turning AI behavior into traces, datasets, judge rubrics, deterministic gates, and managed Bedrock model-eval jobs — then calibrating the judge and writing down what the numbers do and don't prove. [`aws-ai-evals`](https://github.com/rhprasad0/aws-ai-evals) is the current home for this; [`ai-tamperguard`](https://github.com/rhprasad0/ai-tamperguard) and [`genai-mil-hackathon-final`](https://github.com/rhprasad0/genai-mil-hackathon-final) are earlier evaluation labs.
...
### [`aws-ai-evals`](https://github.com/rhprasad0/aws-ai-evals) — AWS-native evaluation harness for an AI product
...
- **Caveat:** active learning/eval repo, not a production eval platform. Current eval receipts are work-in-progress snapshots, not release gates or reliability claims. LLM-as-judge output is calibrated evidence, not ground truth, and repeated-run variance / judge-vs-human calibration are part of the ongoing work. Private run details (account IDs, ARNs, S3 prefixes, raw job output) are kept out of the repo by design.
...
| AI evaluation / model quality / reliability | [`aws-ai-evals`](https://github.com/rhprasad0/aws-ai-evals), [`ai-tamperguard`](https://github.com/rhprasad0/ai-tamperguard), [`genai-mil-hackathon-final`](https://github.com/rhprasad0/genai-mil-hackathon-final), [`policy-bonfire-2`](https://github.com/rhprasad0/policy-bonfire-2), [`data-exfil-prompt-injection-demo`](https://github.com/rhprasad0/data-exfil-prompt-injection-demo) | Bedrock model-eval BYOI jobs, normalized app-event datasets, deterministic citation/refusal/secret gates, judge calibration, CloudWatch/Athena receipts; leakage-aware model bakeoffs, synthetic-data boundaries, prompt-injection and failure harnesses |
...
| Can own the evaluation harness for an AI product | [`aws-ai-evals`](https://github.com/rhprasad0/aws-ai-evals): a recruiter-facing evidence chatbot instrumented in CloudWatch, exported to normalized JSONL datasets, gated by deterministic citation/refusal/secret scorers, then scored by managed AWS Bedrock model-eval jobs with artifacts queryable in Athena. | [`README`](https://github.com/rhprasad0/aws-ai-evals/blob/main/README.md), [`learning plan`](https://github.com/rhprasad0/aws-ai-evals/blob/main/docs/aws-ai-evals-learning-plan.md), [`dataset contracts`](https://github.com/rhprasad0/aws-ai-evals/blob/main/docs/dataset-contracts.md), [`instrumentation`](https://github.com/rhprasad0/aws-ai-evals/blob/main/docs/aws-evals/03-instrumentation.md) | **Medium/high** for public lab evidence; current receipts are work-in-progress snapshots, LLM-as-judge is calibrated evidence (not ground truth), and repeated-run variance is ongoing work rather than an assumed result |
...
| [`aws-ai-evals`](https://github.com/rhprasad0/aws-ai-evals) | AWS-native eval harness around a public candidate-evidence chatbot | Active public learning/eval repo; managed Bedrock eval receipts; private raw artifacts redacted/uncommitted | [`README`](https://github.com/rhprasad0/aws-ai-evals/blob/main/README.md), [`learning plan`](https://github.com/rhprasad0/aws-ai-evals/blob/main/docs/aws-ai-evals-learning-plan.md), [`dataset contracts`](https://github.com/rhprasad0/aws-ai-evals/blob/main/docs/dataset-contracts.md), [`instrumentation`](https://github.com/rhprasad0/aws-ai-evals/blob/main/docs/aws-evals/03-instrumentation.md), [`profile`](https://github.com/rhprasad0/aws-ai-evals/blob/main/content/profile.md) | What did deterministic gates catch vs. what did the Bedrock judge score, and how would repeated-run variance change the conclusion? |
...
|---|---:|---|---|
| [`aws-ai-evals`](https://github.com/rhprasad0/aws-ai-evals) | 2026 | AWS Bedrock model-evals, BYOI datasets, deterministic gates, judge calibration, chatbot eval receipts | Current AWS-native AI evaluation / learning-in-public project |
...
candidate:
  ...
  strongest_signals:
    - Built aws-ai-evals - an AWS-native evaluation harness for a recruiter-facing evidence chatbot using Bedrock model-eval BYOI jobs, deterministic citation/refusal/secret gates, and judge calibration
  ...
  flagship_repos:
    - repo: rhprasad0/aws-ai-evals
      evidence: AWS-native chatbot evaluation harness with CloudWatch traces, normalized BYOI datasets, managed Bedrock model-eval jobs, deterministic citation/refusal/secret gates, judge calibration, and public-safe receipts
...
- [`aws-ai-evals`](https://github.com/rhprasad0/aws-ai-evals) — AWS-native AI evaluation harness around a recruiter-facing evidence chatbot
